...
Run: `pnpm -C apps/api test src/common/access/midterm-reviewers.spec.ts`
...
Run: `pnpm -C apps/api test src/modules/midterm/midterm-turn.spec.ts`
...
**Interfaces:**
- Produces: Prisma 모델 `MidtermTrail`, `MidtermReviewStatus` 신규 값 4개(`commented`·`revised`·`returned`·`closed`), `MidtermReview` 신규 필드 9개
...
Run: `pnpm -C apps/api test src/modules/kpis/kpi-revision.spec.ts`
