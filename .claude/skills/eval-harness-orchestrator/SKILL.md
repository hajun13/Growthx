...
| 디자인 | **TDS(Toss Design System) 디자인 언어** 차용 → 자체 토큰(Tailwind). 앱인토스 플랫폼 비종속 |
...
| [references/tds-design-language.md](references/tds-design-language.md) | 권위 | TDS 디자인 언어 차용·토큰·라이선스 |
