        ...
        right={
          unreadCount > 0 ? (
            <button
              ...
              onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(0,84,202,0.04)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = K.white; }}
            >
              <CheckCheck size={14} />
              모두 읽음
            </button>
          ) : (
            <Button variant="secondary" disabled>모두 읽음</Button>
          )
        }
      />
            ...
            >
              ...
              <div className="flex flex-col divide-y divide-[#f2f3f7]">
                {unreadFiltered.map((n) => (
                  <div
                    key={n.id}
                    style={{ background: 'rgba(0,84,202,0.025)' }}
                  >
                    <NotificationItem
                      data={n}
            ...
            >
              ...
              {unreadFiltered.length > 0 && (
                ...
                >
                  ...
                  <span style={{ fontSize: 12, fontWeight: 700, color: K.onSurfaceVariant }}>읽음</span>
                </div>
              )}
                ...
                {readGroups.map((group, gi) => (
                  <div key={group.label}>
                    ...
                    >
                      ...
                      <span style={{ fontSize: 10.5, fontWeight: 600, color: K.onSurfaceVariant, textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                        {group.label}
                      </span>
                    </div>
                    <div className="flex flex-col divide-y divide-[#f2f3f7]">
