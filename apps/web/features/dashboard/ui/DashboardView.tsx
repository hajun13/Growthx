    ...
    <PageContainer>
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
        <div className="space-y-5">
          <section>
            <h3 className="text-[15px] font-bold text-foreground mb-3">평가 진행</h3>
          ...
          <section>
            <h3 className="text-[15px] font-bold text-foreground mb-3">주요 메뉴</h3>
