...
export function AdminCompetencyItemsView() {
  ...
  const {
    ...
    error,
    reload,
  } = useCompetencyQuestionsData(cycleId, { enabled: allowed });
    ...
    try {
      ...
      if (editing) {
        await competencyQuestionCommands.update(editing.id, {
          ...
          weight,
          appliedLevel:
            draft.appliedLevel as CompetencyQuestionPatch['appliedLevel'],
          options,
        ...
        await competencyQuestionCommands.create({
          ...
          weight,
          appliedLevel:
            draft.appliedLevel as CompetencyQuestionInput['appliedLevel'],
          options,
          isActive: draft.isActive,
        });
      }
