...
export function KpiCard({
  ...
  return (
    <section
      ...
      className="rounded-xl border border-[#cac4d2]/50 bg-card"
    >
      <header className="flex flex-wrap items-center justify-between gap-2 border-b border-[#e7e8ec] px-5 py-3">
