    ...
    <div className="flex flex-col gap-6">
      ...
      <Card title="평가 기간 관리 (잠금/열기)">
        <p className="mb-4 text-sm text-muted-foreground">
          ...
          차단돼요. 임직원 화면 상단에 현재 기간과 마감일이 안내돼요.
        </p>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            <thead>
                  ...
                  <tr key={`lock-${p.phase}`} className="border-t border-border/60">
                    ...
                    <td className="py-2">
                      <button
                        ...
                        onClick={() =>
                          onPhaseChange(p.phase, { isLocked: !locked })
                        }
                        className={cn(
                          'inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-sm font-medium outline-none transition-colors focus-visible:ring-2 focus-visible:ring-ring',
                          locked
